...
PIN_URL=${MENDER_MCU_DD_PIN_URL:-https://raw.githubusercontent.com/DynamicDevices/mender-mcu/feature/zephyr-4.4-mbedtls4/DD_PIN}
...
if [[ "$ACTUAL" != "$EXPECTED" ]]; then
  ...
  echo "  policy: https://github.com/DynamicDevices/mender-mcu/blob/feature/zephyr-4.4-mbedtls4/PIN-POLICY.md" >&2
  exit 5
fi
